            ...
            if (first_ddl.getTime() == new Date(0).getTime()) {
                ...
                if (first_ddl - today <= (2 * 24 * 3600 * 1000)) {
                    ...
                    if (first_ddl - today >= 0) {
                        ...
                        prefix += "<h1>Deadline: " + days + ":" + hours + ":" + minutes + ":" + seconds + "</h1>";

                        this.danger = true;
                    }
                    else {
                        prefix += "<h1>你是否错过了" + first_ddl.toLocaleString() + "的ddl？</h1>";

                        this.danger = true;
                    }
                } else {
                    prefix += "<h1>距离ddl还有" + Math.ceil((first_ddl - today) / 86400000) + " 天</h1>";
                }
            }
